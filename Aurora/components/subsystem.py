...
It is possible to create subsystems of component groups in Aurora. The subsystem
...
available from its original location Aurora/components/subsystems.py
...
class Subsystem:
    ...
    >>> from Aurora.components import Subsystem

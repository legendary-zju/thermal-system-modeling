...
from Aurora.tools.helpers import extend_basic_path
...
class CharLine:
    ...
    components, see the :py:mod:`Aurora.data` module. If you neither specify the
...
def load_custom_char(name, char_type):
    ...
    if os.path.isfile(path):
        ...
        msg = ('The file containing your custom charactersitics could not be '
               ...
               'make sure the .Aurora/data path exists in your home directory.')
        logger.error(msg)

...
from Aurora.tools.fluid_properties import single_fluid
...
class ExergyAnalysis:
    ...
    def __init__(self, network, E_F, E_P, E_L=[], internal_busses=[]):
        ...
        >>> from Aurora.components import (CycleCloser, SimpleHeatExchanger,
        ...
        >>> from Aurora.tools import ExergyAnalysis
    ...
    def generate_plotly_sankey_input(
        ...
        colors : dict
            ...
            - names of the pure fluids of the Aurora Network
